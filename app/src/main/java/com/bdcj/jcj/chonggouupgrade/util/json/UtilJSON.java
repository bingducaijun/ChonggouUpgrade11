package com.bdcj.jcj.chonggouupgrade.util.json;

import com.bdcj.jcj.chonggouupgrade.util.String.UtilString;
import com.bdcj.jcj.chonggouupgrade.util.map.UtilMap;
...
public class UtilJSON
{
	 ...
	 *         <li>return {@link UtilJSON#getLong(String, String, Long)}</li>
	 *         </ul>
	 */
	 ...
	 *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception,
	 *         return defaultValue</li>
	 *         <li>return {@link UtilJSON#getInt(JSONObject, String, int)}</li>
	 *         </ul>
	 */
	 ...
	 *         <li>if jsonData {@link JSONObject#JSONObject(String)} exception,
	 *         return defaultValue</li>
	 *         <li>return {@link UtilJSON#getString(String, String, String)}
	 *         </li>
	 *         </ul>
	 */
	 ...
	 *         <li>else parse entry by one by one</li>
	 *         </ul>
	 */
	 ...
	 * @return
	 *         <ul>
	 *         <li>if source is null or source's length is 0, return empty
	 *         map</li>
	 *         <li>if source {@link JSONObject#JSONObject(String)} exception,
	 *         return null</li>
	 *         <li>return
	 *         {@link UtilJSON#parseKeyAndValueToMap(JSONObject)}</li>
	 *         </ul>
	 */
