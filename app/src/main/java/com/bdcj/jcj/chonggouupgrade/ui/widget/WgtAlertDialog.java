package com.bdcj.jcj.chonggouupgrade.ui.widget;
...
public class WgtAlertDialog
{
	 ...
	 * @param titleText
	 */
	public void show(Context context, String leftBtnText, String rightBtnText, String msg, View.OnClickListener left, View.OnClickListener right, int titleDrawable, String titleText)
	{
	 ...
	 * @param titleText
	 */
	public void show(Context context, String leftBtnText, String rightBtnText, String msg, View.OnClickListener left, View.OnClickListener right, boolean cancelOnTouchOutside, boolean cancelable, int titleDrawable, String titleText)
	{
