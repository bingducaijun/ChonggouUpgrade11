...
public class BusinessCommon extends BusinessBase
{
	...
	public void getCommunity(String communityID)
	{
        RequestParams params = new RequestParams();
        params.addQueryStringParameter("COMMUNITYID", communityID);
        send(AffConstants.BUSINESS.COMMON_GETCOMMUNITY, params, mContext, AffConstants.BUSINESS.TAG_COMMON_GETCOMMUNITY, SEND_ENTITYLOCTION);
	}
}
